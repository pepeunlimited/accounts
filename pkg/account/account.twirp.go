...
/*
Package accountsrpc is a generated twirp stub package.
...
type AccountService interface {
	CreateDeposit(context.Context, *CreateDepositParams) (*Account, error)
...
func (c *accountServiceProtobufClient) CreateDeposit(ctx context.Context, in *CreateDepositParams) (*Account, error) {
...
func (c *accountServiceProtobufClient) CreateWithdraw(ctx context.Context, in *CreateWithdrawParams) (*Account, error) {
	ctx = ctxsetters.WithPackageName(ctx, "pepeunlimited.accounts")
	ctx = ctxsetters.WithServiceName(ctx, "AccountService")
...
func (c *accountServiceJSONClient) CreateDeposit(ctx context.Context, in *CreateDepositParams) (*Account, error) {
	ctx = ctxsetters.WithPackageName(ctx, "pepeunlimited.accounts")
	ctx = ctxsetters.WithServiceName(ctx, "AccountService")
	ctx = ctxsetters.WithMethodName(ctx, "CreateDeposit")
	out := new(Account)
...
func (c *accountServiceJSONClient) CreateWithdraw(ctx context.Context, in *CreateWithdrawParams) (*Account, error) {
	ctx = ctxsetters.WithPackageName(ctx, "pepeunlimited.accounts")
	ctx = ctxsetters.WithServiceName(ctx, "AccountService")
	ctx = ctxsetters.WithMethodName(ctx, "CreateWithdraw")
	out := new(Account)
...
func (s *accountServiceServer) serveCreateDepositJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Account and nil error while calling CreateDeposit. nil responses are not supported"))
		return
	}
...
func (s *accountServiceServer) serveCreateWithdrawJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Account and nil error while calling CreateWithdraw. nil responses are not supported"))
		return
	}
